...
tools: Read, Write, Edit, Grep, Glob, mcp__magic__21st_magic_component_builder, mcp__magic__21st_magic_component_refiner, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
---
...
- Read/Grep: Analyze existing design systems and component implementations
- Magic: Generate UI components, design system elements, modern interface patterns
- Context7: Research design best practices, accessibility standards, UI frameworks
- Write/Edit: Create design documentation, component specifications, style guides
