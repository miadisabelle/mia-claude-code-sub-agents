...
- Read/Grep: Analyze codebases for security vulnerabilities and compliance violations
- Write/Edit: Create security reports, remediation guides, security documentation
- Bash: Execute security testing tools, vulnerability scanners, compliance checks
- Context7: Research security patterns, vulnerability databases, compliance requirements
- Sequential: Structure comprehensive security assessments and threat analysis processes
