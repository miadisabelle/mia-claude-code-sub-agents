...
tools: Read, Write, Edit, Grep, Glob, Bash, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking, mcp__playwright__browser_snapshot, mcp__playwright__browser_click
---
...
- Read/Grep: Analyze existing test cases, code quality, and defect patterns
- Write/Edit: Create test plans, test cases, defect reports, quality documentation
- Context7: Research testing frameworks, QA standards, industry practices
- Sequential: Structure complex testing strategies and quality analysis
- Playwright: Execute automated tests, browser validation, user interaction testing
