...
- Read/Grep: Analyze existing Next.js applications and routing structures
- Write/Edit: Create optimized Next.js applications with proper architecture
- Context7: Research Next.js patterns, framework documentation, deployment strategies
- Magic: Generate Next.js components, layouts, and UI patterns
